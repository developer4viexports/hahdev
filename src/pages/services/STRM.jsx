    ...
    const services = [
        {
            ...
            details:
                "We create eye-catching listings with high-quality photography, captivating copywriting, and strategically chosen titles. Combined with optimized pricing and platform integration, we position your property for higher visibility and better conversions.",
        },
        {
            id: "panel2",
            title: "Guest Communication & Booking Management",
            details:
                "From the first inquiry to the final review, we manage all guest interactions with professionalism and warmth. Our team is available around the clock to answer questions, confirm bookings, coordinate check-ins, and ensure a frictionless guest experience.",
        },
        {
            id: "panel3",
            title: "Housekeeping & Maintenance",
            details:
                "First impressions matter. Our professional cleaning crews ensure spotless turnovers between stays, while our maintenance team provides routine inspections and urgent fixes to keep your property fresh, functional, and guest-ready at all times.",
        },
        {
            id: "panel4",
            title: "Dynamic Pricing & Revenue Management",
            details:
                "Our system continuously monitors market demand, local events, seasonal trends, and competitor rates to automatically adjust your pricing. This ensures you’re earning the maximum possible income without sacrificing occupancy.",
        },
        {
            id: "panel5",
            title: "Compliance & Licensing",
            details:
                "We handle all aspects of legal compliance, including tax filings, municipal permits, health and safety standards, and licensing requirements. This keeps your rental operations smooth, lawful, and stress-free.",
        },
    ];
    const points = [
